      ...
      <div class="card settings-card">
        ...
        <div class="form-row">
          ...
          <div>
            ...
            <input type="text" id="cfg-model" class="mono-input" value="${escapeHtml(cfg.model)}" placeholder="deepseek-chat">
          </div>
        </div>

        <div id="cfg-custom-wrap" class="settings-custom-wrap" hidden>
